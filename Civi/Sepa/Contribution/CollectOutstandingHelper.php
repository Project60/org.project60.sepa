...
final class CollectOutstandingHelper {
   ...
   */
  public function cancelLinkedOutstandingContributions(array $mandateIds): void {
    ...
    $linkedPendingOnHoldContributionIds = Contribution::get(FALSE)
      ...
      ->addJoin(
        ...
        [
          ...
          '=',
          '"' . MandateLinkClasses::COLLECT_OUTSTANDING . '"',
        ],
      )
   ...
   * @throws \CRM_Core_Exception
   */
  public function getOutstandingContributions(int $contributionRecurId): array {
   ...
   *   Contributions as returned by {@link getOutstandingContributions()}.
   */
  public function getOutstandingAmount(array $contributions): float {
    if ([] === $contributions) {
      return 0.0;
    }
    ...
    return round(
      ...
      \CRM_Utils_Money::getCurrencyPrecision($contributions[0]['currency'] ?? \Civi::settings()->get('defaultCurrency'))
    );
  }
