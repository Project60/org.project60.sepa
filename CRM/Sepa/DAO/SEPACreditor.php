 ...
 * (GenCodeChecksum:a8e4b2122ae0a19b02007872834ae7a1)
 */
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'name' => [
          'name' => 'name',
          'type' => CRM_Utils_Type::T_STRING,
          'title' => E::ts('name of the creditor'),
          'description' => E::ts('by default creditor_id.display_name snapshot at creation'),
          'maxlength' => 255,
