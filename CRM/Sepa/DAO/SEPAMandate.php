 ...
 * (GenCodeChecksum:72958e8f9d4dfd8ad0f092601d2e947b)
 */
...
class CRM_Sepa_DAO_SEPAMandate extends CRM_Core_DAO {
  ...
  /**
   * Physical table name for the contribution entity being joined (civicrm_contribution or civicrm_contribution_recur)
   *
   * @var string|null
   *   (SQL type: varchar(64))
   *   Note that values will be retrieved from the database as a string.
