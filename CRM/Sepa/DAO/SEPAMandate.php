 ...
 * (GenCodeChecksum:d328f3f8f6c6b40e3553ace3f72229c9)
 */
...
class CRM_Sepa_DAO_SEPAMandate extends CRM_Core_DAO {
  ...
  /**
   * Physical tablename for the contract entity being joined (civicrm_contribution or civicrm_contribution_recur)
   *
   * @var string|null
   *   (SQL type: varchar(64))
   *   Note that values will be retrieved from the database as a string.
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'entity_table' => [
          ...
          'description' => E::ts('Physical tablename for the contract entity being joined (civicrm_contribution or civicrm_contribution_recur)'),
          'maxlength' => 64,
          'size' => CRM_Utils_Type::BIG,
          'usage' => [
            'import' => FALSE,
