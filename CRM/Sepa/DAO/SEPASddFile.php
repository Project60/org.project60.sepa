 ...
 * (GenCodeChecksum:8dad2e8b15f547c6529bf0e622313744)
 */
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'reference' => [
          ...
          'description' => CRM_Sepa_ExtensionUtil::ts('End-to-end reference for this sdd file.'),
          'maxlength' => 64,
        ...
        'filename' => [
          'name' => 'filename',
          'type' => CRM_Utils_Type::T_STRING,
          'title' => CRM_Sepa_ExtensionUtil::ts('Filename'),
          'description' => CRM_Sepa_ExtensionUtil::ts('Name of the generated file'),
          'maxlength' => 64,
          'size' => CRM_Utils_Type::BIG,
        ...
        'latest_submission_date' => [
          ...
          'title' => CRM_Sepa_ExtensionUtil::ts('Latest Submission Date'),
          'description' => CRM_Sepa_ExtensionUtil::ts('Latest submission date'),
        ...
        'created_date' => [
          'name' => 'created_date',
          'type' => CRM_Utils_Type::T_DATE + CRM_Utils_Type::T_TIME,
          'title' => CRM_Sepa_ExtensionUtil::ts('Created Date'),
          'description' => CRM_Sepa_ExtensionUtil::ts('When was this item created'),
        ...
        'created_id' => [
          'name' => 'created_id',
          'type' => CRM_Utils_Type::T_INT,
          'description' => CRM_Sepa_ExtensionUtil::ts('FK to Contact ID of creator'),
        ...
        'status_id' => [
          'name' => 'status_id',
          'type' => CRM_Utils_Type::T_INT,
          'description' => CRM_Sepa_ExtensionUtil::ts('fk to Batch Status options in civicrm_option_values'),
          'required' => TRUE,
        ...
        'comments' => [
          ...
          'title' => CRM_Sepa_ExtensionUtil::ts('Comments'),
          'description' => CRM_Sepa_ExtensionUtil::ts('Comments about processing of this file'),
        ...
        'tag' => [
          ...
          'description' => CRM_Sepa_ExtensionUtil::ts('Tag used to group multiple creditors in this XML file.'),
          'maxlength' => 64,
          'size' => CRM_Utils_Type::BIG,
