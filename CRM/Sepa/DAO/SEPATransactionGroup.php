 ...
 * @copyright CiviCRM LLC (c) 2004-2014
 *
 * Generated from xml/schema/CRM/Sepa/SEPATransactionGroup.xml
...
class CRM_Sepa_DAO_SEPATransactionGroup extends CRM_Core_DAO
{
  ...
  static function getReferenceColumns()
  {
    if (!self::$_links) {
      ...
      self::$_links[] = new CRM_Core_Reference_Basic(self::getTableName() , 'sdd_creditor_id', 'civicrm_sdd_creditor', 'id');
      self::$_links[] = new CRM_Core_Reference_Basic(self::getTableName() , 'sdd_file_id', 'civicrm_sdd_file', 'id');
    }
    return self::$_links;
  }
  /**
