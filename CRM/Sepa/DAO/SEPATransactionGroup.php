 ...
 * (GenCodeChecksum:e7659ced2a05d0dc52304964453bc9d0)
 */
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'reference' => [
          ...
          'description' => CRM_Sepa_ExtensionUtil::ts('End-to-end reference for this tx group.'),
          'maxlength' => 64,
        ...
        'type' => [
          ...
          'description' => CRM_Sepa_ExtensionUtil::ts('FRST, RCUR or OOFF'),
          'maxlength' => 4,
        ...
        'collection_date' => [
          ...
          'title' => CRM_Sepa_ExtensionUtil::ts('Collection Date'),
          'description' => CRM_Sepa_ExtensionUtil::ts('Target collection date'),
        ...
        'status_id' => [
          'name' => 'status_id',
          'type' => CRM_Utils_Type::T_INT,
          'description' => CRM_Sepa_ExtensionUtil::ts('fk sepa group Status options in civicrm_option_values'),
          'required' => TRUE,
        ...
        'sdd_creditor_id' => [
          ...
          'type' => CRM_Utils_Type::T_INT,
          'description' => CRM_Sepa_ExtensionUtil::ts('fk to SDD Creditor Id'),
        ...
        'sdd_file_id' => [
          'name' => 'sdd_file_id',
          'type' => CRM_Utils_Type::T_INT,
          'description' => CRM_Sepa_ExtensionUtil::ts('fk to SDD File Id'),
