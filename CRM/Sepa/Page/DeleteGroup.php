  ...
  function run() {
    ...
    if (empty($_REQUEST['group_id'])) {
      ...
      try {
        ...
        $txgroup['status_label'] = CRM_Core_PseudoConstant::getLabel(
          'CRM_Batch_BAO_Batch',
          'status_id',
          $txgroup['status_id']
        );
        $txgroup['status_name'] = CRM_Core_PseudoConstant::getName(
          'CRM_Batch_BAO_Batch',
          'status_id',
          $txgroup['status_id']
        );
      ...
      if (empty($_REQUEST['confirmed'])) {
        ...
        $PENDING = (int) CRM_Core_PseudoConstant::getKey(
        ...
        $stats = ['busy' => 0, 'open' => 0, 'other' => 0, 'total' => 0];
