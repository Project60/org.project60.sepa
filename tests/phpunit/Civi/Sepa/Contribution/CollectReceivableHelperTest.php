...
/**
 * @covers \Civi\Sepa\Contribution\CollectOutstandingHelper
 *
 * @group headless
 */
final class CollectOutstandingHelperTest extends AbstractSepaHeadlessTestCase {
  ...
  public function testCancelLinkedOnHoldContributions(): void {
    ...
    $createLink = SepaMandateLink::create(FALSE)
      ->setValues([
        ...
        'class' => MandateLinkClasses::COLLECT_OUTSTANDING,
      ]);
    ...
    $collectOutstandingHelper->cancelLinkedOutstandingContributions([$mandate1['id']]);

    // Status of pending on hold contribution linked with class
    // "OUTSTANDING" to mandate1 should be cancelled.
  ...
  public function testGetOutstandingContributions(): void {
    ...
    $collectOutstandingHelper = new CollectOutstandingHelper();
    static::assertSame([], $collectOutstandingHelper->getOutstandingContributions($mandate['entity_id']));
    ...
    ], $collectOutstandingHelper->getOutstandingContributions($mandate['entity_id']));
  }

  public function testGetOutstandingAmount(): void {
    $collectOutstandingHelper = new CollectOutstandingHelper();
    static::assertSame(0.0, $collectOutstandingHelper->getOutstandingAmount([]));
    static::assertSame(
      3.3,
      $collectOutstandingHelper->getOutstandingAmount([
