...
final class PaymentInstrumentDeterminerTest extends AbstractSepaHeadlessTestCase {
  ...
  public function testDetermineCollectOutstandingPaymentInstrument(): void {
    ...
    static::assertSame(3, $paymentInstrumentDeterminer->determineCollectOutstandingPaymentInstrument($creditorId, 3));

    // Given RCUR payment instrument ID is not a valid OOFF payment instrument ID.
    // First OOFF payment instrument ID is returned.
    static::assertSame(2, $paymentInstrumentDeterminer->determineCollectOutstandingPaymentInstrument($creditorId, 4));
    ...
    $paymentInstrumentDeterminer->determineCollectOutstandingPaymentInstrument($creditorId, 3);
  }
