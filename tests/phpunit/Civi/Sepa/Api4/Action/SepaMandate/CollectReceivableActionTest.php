...
/**
 * @covers \Civi\Sepa\Api4\Action\SepaMandate\CollectOutstandingAction
 * @covers \Civi\Api4\SepaMandate
 *
 * @group headless
 */
final class CollectOutstandingActionTest extends AbstractSepaHeadlessTestCase {
  ...
  public function test(): void {
    ...
    $result = SepaMandate::collectOutstanding()
    ...
    static::assertSame(
      "Outstanding amounts of mandate {$mandate['reference']}",
      $ooffMandate['source']
    );
    ...
    static::assertSame(1, SepaMandateLink::get(FALSE)
      ...
      ->addWhere('class', '=', MandateLinkClasses::COLLECT_OUTSTANDING)
    ...
    static::assertSame([], SepaMandate::collectOutstanding()
      ->addWhere('id', '=', $mandate['id'])
      ->execute()
      ->getArrayCopy()
    );
