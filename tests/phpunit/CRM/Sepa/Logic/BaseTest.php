...
class CRM_Sepa_Logic_BaseTest extends CiviUnitTestCase {
  ...
  function adjustBankDays_provider() {
    return array(
      ...
      'datetime input' => array(array('2015-04-21 04:14:00', 1), new CRM_Exception('Failed parsing date')),
      'input with timezone' => array(array('2015-04-21 04:14:00 CEST', 1), new CRM_Exception('Failed parsing date')),
      'timezone causing day advance' => array(array('2015-04-21 23:00:00 -02:00', 1), new CRM_Exception('Failed parsing date')),
      'timezone causing day delay' => array(array('2015-04-21 01:00:00 CEST', 1), new CRM_Exception('Failed parsing date')),
