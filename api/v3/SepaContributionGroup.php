  ...
  foreach ($result['values'] as $recur) {
    ...
    for ($period = $lastPeriod + 1; $lastDueDate < $today && (!$installments || $period < $installments); ++$period, $lastDueDate = $dueDate) {
      ...
      $result = civicrm_api3('Contribution', 'create', array(
        ...
        'contribution_page_id' => CRM_Utils_Array::value('contribution_page_id', $lastContrib),
        ...
        'source' => CRM_Utils_Array::value('source', $lastContrib),
        'amount_level' => CRM_Utils_Array::value('amount_level', $lastContrib),
        'contribution_recur_id' => $recur['id'],
        'honor_contact_id' => CRM_Utils_Array::value('honor_contact_id', $lastContrib),
        'is_test' => $recur['is_test'],
        'contribution_status_id' => CRM_Core_OptionGroup::getValue('contribution_status', 'Pending', 'name'),
        'honor_type_id' => CRM_Utils_Array::value('honor_type_id', $lastContrib),
        'address_id' => CRM_Utils_Array::value('address_id', $lastContrib),
        'campaign_id' => CRM_Utils_Array::value('campaign_id', $recur),
