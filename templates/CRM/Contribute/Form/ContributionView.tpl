...
<div class="action-link">
    ...
    {if call_user_func(array('CRM_Core_Permission','check'), 'edit contributions')}
       ...
       {/if}
       <a class="button" href="{crmURL p='civicrm/contact/view/contribution' q=$urlParams}" accesskey="e"><span><div class="icon edit-icon ui-icon-pencil"></div>{ts}Edit{/ts}</span></a>
    {/if}
    {if call_user_func(array('CRM_Core_Permission','check'), 'delete in CiviContribute')}
       ...
       {/if}
       <a class="button" href="{crmURL p='civicrm/contact/view/contribution' q=$urlParams}"><span><div class="icon delete-icon ui-icon-trash"></div>{ts}Delete{/ts}</span></a>
    {/if}
