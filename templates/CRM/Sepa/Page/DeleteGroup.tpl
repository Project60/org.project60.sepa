...
<p>
	...
	{if $txgroup.status_name neq 'Open'}
		...
		{/if}
		<p class="status message"><i class="crm-i fa-exclamation-triangle" role="img" aria-hidden="true"></i>{ts domain="org.project60.sepa"}Only proceed if you know what you're doing.{/ts}</p>
	{/if}
</p>
