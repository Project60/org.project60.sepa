...
Based on the settings (check [Configuration Example](config-example.md)) it will generate contributions for all recurring mandates that are 30 days ahead (horizon).
